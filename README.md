...
**Scope Prefix:** `x_ai_agent_validator`
...
AI Agent Validator is an enterprise-grade ServiceNow scoped application designed to solve critical platform challenges that organizations face during upgrades, migrations, and operational governance. Validates AI agent skill definitions, intent mappings, and conversation flows against ServiceNow AI Agent Studio standards, ensuring compliance before production deployment. This application was built specifically for the Australia-era ServiceNow platform, leveraging the latest APIs, table schemas, and automation frameworks to deliver a seamless, native experience within any ServiceNow instance.
...
## Overview
sn_ai_agent_validator is a production-grade ServiceNow scoped application developed by Vladimir Kapustin under AGPL-3.0.

## Architecture
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| sn_ai_agent_validator
    sn_ai_agent_validator -->|Store| DB[x_sn_ai_agent_validator_tables]
    sn_ai_agent_validator -->|Output| Report[Reports MD/JSON/CSV]
...
## Installation
```bash
git clone https://github.com/vladarchitectservicenow-oss/sn_ai_agent_validator.git
cd sn_ai_agent_validator
...
## ROI Analysis
| Metric | Manual Process | With sn_ai_agent_validator |
|--------|---------------|-------------|
...
# Run scan
POST /api/x_sn_ai_agent_validator/scan
...
See `Validation/TEST CASES/sn_ai_agent_validator/test_suite_SOP.md`
...
## Support
- GitHub Issues: https://github.com/vladarchitectservicenow-oss/sn_ai_agent_validator/issues
- ServiceNow Community: Tag `sn_ai_agent_validator`
